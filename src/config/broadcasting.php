    ...
    */
    ...
    'connections' => [
        ...
        'centrifugo' => [
            ...
            'url'     => env('CENTRIFUGO_URL', 'http://centrifugo:8010'), // centrifugo api url
            ...
            'token_expire_time' => env('CENTRIFUGO_TOKEN_EXPIRE', 3600), //Default token expire time. Used in channel subscriptions /broadcasting/auth
        ],
